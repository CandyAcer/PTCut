// $Intro: 本文件通过四个类的相互协作, 实现对多面体网格属性的管理.
...
#ifndef MCAL_POLYHEDRON_GRID_PROPERTY_H
#define MCAL_POLYHEDRON_GRID_PROPERTY_H
    ...
    namespace GRID {   // 存放多面体网格实现的相关代码
        ...
        */
        ...
        public: /*基类纯虚函数的实现*/
            ...
            {
                PropertyArray<T>* p = new PropertyArray<T>(this->property_name, this->default_value);
        ...
        *        即PropertyContainer主要负责属性的存储, PropertyMap负责属性值的修改和获取.
        *
        * @param RefClass：所在的类, 一般为PolyhedronGrid
        ...
        *
        * Note: CGAL的实现中, PropertyMap继承自boost::put_get_helper,
        *       put和get接口依赖于本类的operator[]方法, 我们直接使用该方法.
        *
